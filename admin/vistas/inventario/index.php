...
<body class="bg-dark">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <a href="modificarp-listar.php"><div class="card h-100 bg-dark p-4 bg-opacity-75" id="caja">
            <div class="card-body">
        ...
        <div class="col">
            <a href="consultar-producto.php"><div class="card h-100 bg-dark p-4 bg-opacity-75" id="caja">
            <div class="card-body">
