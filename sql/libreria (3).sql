...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-01-2023 a las 18:57:46
...
CREATE TABLE `autor` (
  ...
  `apellidoAutor` varchar(25) COLLATE utf8_spanish2_ci DEFAULT NULL
...
INSERT INTO `libro_autor` (`idLibro_autor`, `idLibro`, `idAutor`) VALUES
(1, 6, 8),
(2, 8, 9);
...
--
ALTER TABLE `libro_autor`
  MODIFY `idLibro_autor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
