...
<body class="bg-secondary">
    ...
    <div class="container">
        ...
        <form id="formulario">
            ...
            <button type="button" id="btnBuscar" onclick="buscar()"> Buscar </button>
        </form>
        ...
        <script>
                function buscar() 
                {
                    ...
                    if (busqueda.trim() !== '') {
                        // Aquí puedes hacer la petición AJAX para obtener los resultados de la búsqueda
                        // y mostrarlos en la página sin necesidad de recargarla
                        var xhttp = new XMLHttpRequest();
                        xhttp.onreadystatechange = function() {
                            if (this.readyState === 4 && this.status === 200) {
                                // Aquí actualizas el contenido de la página con los resultados de la búsqueda
